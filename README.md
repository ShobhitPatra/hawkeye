...
Status: milestone 2 in progress; the CLI is published as [`hawkeye-review`](https://www.npmjs.com/package/hawkeye-review) on npm. This README is the design document; see "Run it" below.
