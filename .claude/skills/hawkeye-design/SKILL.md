...
Roots and shell: `hk-root`, `hk-topbar[data-sticky]`, `hk-footer`, `hk-wordmark`, `hk-wordmark-text`, `hk-nav`, `hk-topbar-end`, `hk-account-name`, `hk-account-initial`, `hk-fresh`, `hk-menu` (a `<details>`; `data-icon` for an icon-only summary), `hk-menu-panel`, `hk-menu-who`, `hk-menu-theme`, `hk-menu-row`, `hk-menu-legal`, `hk-progress`, `hk-page`.
